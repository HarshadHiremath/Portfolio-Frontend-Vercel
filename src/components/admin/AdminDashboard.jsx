    ...
    <div className="min-h-screen bg-[#050505] text-gray-300 font-mono p-1 md:p-1 selection:bg-green-500/30">
      ...
      <header className="max-w-7xl mx-auto mb-12 flex items-center justify-between border-b border-white/5 pb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-black uppercase text-white tracking-tighter">
            Traffic<span className="text-green-500">_Intelligence</span>
          </h1>
        </div>
      ...
      <main className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-end gap-4 border-l-2 border-green-500 pl-4">
          <div>
            <h2 className="text-green-500 text-[12px] font-bold uppercase tracking-[0.1em]">Signal_Intercept</h2>
            <p className="text-xl text-white font-bold uppercase tracking-tight">Active Visitor Logs</p>
          </div>
        </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-6 items-center">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-[12px] text-gray-400 uppercase font-bold">Client IP</p>
                      <p className="text-sm font-bold text-gray-200 tracking-wider">{v.ip}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-[12px] text-gray-400 font-bold uppercase">System OS</p>
                      <p className="text-sm text-gray-200 font-bold truncate uppercase">{v.osName} / {v.browserName}</p>
                    </div>
                  </div>

                  {/* Device Info */}
                  <div className="flex items-center gap-3">
                    {v.device === "mobile" ? <Smartphone size={14} className="text-gray-600" /> : <Monitor size={18} className="text-gray-600" />}
                    <div>
                      <p className="text-[12px] font-bold text-gray-400 uppercase">Device_Node</p>
                      <p className="text-sm font-bold text-gray-200 uppercase">{v.deviceBrand || "Generic"} {v.device}</p>
                    </div>
                  </div>
                  ...
                  {/* <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-[9px] text-gray-500 uppercase">Entry_Point</p>
                      <p className="text-[11px] text-green-400 truncate uppercase">{v.page}</p>
                    </div>
                  </div> */}
                  ...
                  <div className="flex items-center gap-3 md:hidden lg:flex">
                    ...
                    <div>
                      <p className="text-[12px] font-bold text-gray-400 uppercase">Resolution</p>
                      <p className="text-[10px] text-gray-200 uppercase">{v.screenSize} | {v.language}</p>
                    </div>
                  </div>
                ...
                <div className="mt-4 pt-3 border-t border-white/5 flex justify-between items-center text-[10px] text-gray-400 uppercase tracking-widest">
                  <span className="flex items-center gap-1">
                    <Clock size={14} /> Recvd: {new Date(v.createdAt).toLocaleString()}
                  </span>
                  <span className="truncate max-w-[200px] md:max-w-md">
                    Ref: {v.referrer || "Direct_Uplink"}
                  </span>
                </div>
              </motion.div>
            ))}
