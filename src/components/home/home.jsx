...
const MetricItem = ({ icon, label, value, color, isLive }) => (
    ...
    >
        ...
        <div className="relative">
            <p
                className={`text-4xl md:text-5xl font-black tracking-tighter transition-all duration-300 ${color} group-hover:drop-shadow-[0_0_15px_rgba(34,197,94,0.4)]`}
            >
...
const HomePage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-slate-200 font-sans selection:bg-green-500 selection:text-black">
            ...
            <section className="pb-32 px-10 relative overflow-hidden">
                        ...
                        <div className="relative bg-[#080808]/80 backdrop-blur-xl border border-white/10 rounded-[28px] p-10 md:p-16 overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4 relative z-10">
                                <div>
                                    ...
                                    <p className="text-green-500 font-mono text-[12px] tracking-[0.2em] uppercase">
                                        Real-Time_Data_Monitoring
                                    </p>
                                </div>
                            ...
                            {/* System Load Bar */}
                            <div className="mt-1 pt-8 border-t border-white/5 relative z-10">
